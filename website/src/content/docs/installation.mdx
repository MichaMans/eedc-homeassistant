...
:::caution[Wichtig]
Für den direkten Zugriff auf die Home-Assistant-Langzeitstatistik braucht das Add-on Lesezugriff auf die HA-Konfiguration. Er ist im Add-on eingebaut und muss nicht eingerichtet werden.
:::
